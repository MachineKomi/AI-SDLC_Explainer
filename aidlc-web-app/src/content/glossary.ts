...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  // Principles
  {
    id: 'golden-thread',
    term: 'Golden Thread',
    definition: 'The continuous, unbroken path of context and intent from business goal to deployed code. Preserved by artifacts, not chat history.',
    example: 'Intent → Units → Code → Deployment. If this thread breaks, hallucination risk increases.',
    related: ['context', 'artifact', 'gate'],
    source: 'lessons.ts (content alignment)',
  },
  {
    id: 'reimagine',
    term: 'Reimagine (Don\'t Retrofit)',
    definition: 'Principle 1: Redesign workflows from first principles for AI speed (hours/days), rather than patching AI into slow legacy rituals (weeks).',
    example: 'Instead of a 2-week Sprint, use a 4-hour Bolt.',
    related: ['bolt', 'aidlc'],
    source: 'AI-SDLC_best-practice_method_principles.md#L17-19',
  },
  {
    id: 'reverse-conversation',
    term: 'Reverse Conversation',
    definition: 'Principle 2: AI initiates and proposes; humans review and approve. Shifts human role from "doer" to "approver/designer".',
    example: 'AI: "Here is the plan for the login page." Human: "Approved."',
    related: ['human-accountability', 'proactive-ai'],
    source: 'AI-SDLC_best-practice_method_principles.md#L21-23',
  },
  // Principles (Existing & New)
  {
    id: 'human-accountability',
    term: 'Human Accountability',
    definition: "Principle that humans own decisions. AI proposes, humans dispose. The 'loss function' of AI-SDLC.",
  ...
  },
  {
    ...
    definition: "Principle that 'done' requires objective evidence (tests passing, checks green), not just textual claims.",
    example: 'Unit is done when: tests pass, lint clean, security scan green.',
  ...
  },
  {
    id: 'plan-first',
    term: 'Plan-First',
    definition: 'Principle 10 (related): No hard-wired workflows; context determines plan. Also General Principle: Always plan before executing.',
    example: 'Create tasks-plan.md with checkboxes, get approval, then execute.',
    related: ['gate', 'approval', 'reimagine'],
    source: 'AI-SDLC_best-practice_method_principles.md#L53-55',
  },
  {
    id: 'small-batches',
    term: 'Small Batches',
    definition: 'Principle: Fast cycles. Decompose work into units (Bolts) enabled by AI speed.',
    example: "Break 'User Management' into small Bolts.",
  ...
  // 5 Levels & Operationalization Concepts
  {
    id: 'dark-factory',
    term: 'Dark Factory',
    definition: 'A software development environment where AI agents autonomously build, test, and ship software with the lights off. Humans write specifications and evaluate outcomes — no human writes or reviews code.',
    example: 'StrongDM runs a 3-person dark factory: specs go in, production software comes out. 16,000 lines of Rust shipped by agents end-to-end.',
    related: ['levels-of-ai-coding', 'scenario-holdout', 'digital-twin', 'spec-quality'],
    source: '5 Levels of AI Coding (Nate B Jones, 2026)',
  },
  {
    id: 'scenario-holdout',
    term: 'Scenario (Holdout)',
    definition: 'A behavioral specification stored outside the codebase that evaluates whether AI-built software works correctly. The agent never sees the evaluation criteria during development, preventing it from optimizing for test passage rather than correct behavior.',
    example: 'StrongDM stores scenarios externally. The AI builds the software, then scenarios evaluate it — like a holdout set in ML that prevents overfitting.',
    related: ['dark-factory', 'proof-over-prose', 'build-and-test'],
    source: '5 Levels of AI Coding (Nate B Jones, 2026)',
  },
  {
    id: 'digital-twin',
    term: 'Digital Twin',
    definition: 'A simulated clone of every external service the software interacts with (APIs, auth providers, databases, SaaS tools). AI agents develop against digital twins for safe end-to-end integration testing without touching production systems.',
    example: 'StrongDM maintains digital twins of Okta, Jira, Slack, Google Docs — agents run full integration scenarios against these simulated services.',
    related: ['dark-factory', 'scenario-holdout', 'operations'],
    source: '5 Levels of AI Coding (Nate B Jones, 2026)',
  },
  {
    id: 'j-curve',
    term: 'J-Curve',
    definition: 'The initial productivity dip experienced when adopting AI coding tools before workflows are redesigned around them. Developers get measurably slower because the tool changes the workflow, but the workflow has not been redesigned for the tool.',
    example: 'METR study (2025): experienced open-source developers using AI tools took 19% longer to complete tasks — while believing they were 24% faster.',
    related: ['levels-of-ai-coding', 'reimagine'],
    source: '5 Levels of AI Coding (Nate B Jones, 2026)',
  },
  {
    id: 'elevation',
    term: 'Elevation (Brownfield)',
    definition: 'An AI-SDLC step where AI reverse-engineers an existing codebase into static models (components + relationships) and dynamic models (interaction flows) before making any changes. Mandatory for brownfield projects.',
    example: 'Before modifying a legacy monolith, AI produces component diagrams and interaction flows. The team validates these models, then proceeds with construction.',
    related: ['brownfield', 'reverse-engineering', 'inception'],
    source: 'AI-DLC Operationalization Cheat Sheet (Jonas Directory)',
  },
  {
    id: 'human-override-rate',
    term: 'Human Override Rate',
    definition: 'The percentage of AI outputs modified by humans during validation gates. A key calibration metric: 10–25% is healthy, above 25% means AI needs richer context, below 5% is a red flag indicating rubber-stamping.',
    example: 'Team override rate dropped from 31% to 22% over two weeks — AI is getting better calibrated as context improves.',
    related: ['gate', 'proof-over-prose', 'human-accountability'],
    source: 'AI-DLC Operationalization Cheat Sheet (Jonas Directory)',
  },
  {
    id: 'rosetta-stone',
    term: 'Rosetta Stone',
    definition: 'A mapping table that translates familiar Agile/Waterfall concepts to their AI-SDLC equivalents. Used to orient teams during transition — most of the "new" is actually familiar, just faster and AI-initiated.',
    example: 'Sprint → Bolt, Sprint Planning → Mob Elaboration, Velocity → Business Value Delivered, Scrum Master → Role absorbed.',
    related: ['bolt', 'mob-elaboration', 'reimagine'],
    source: 'AI-DLC Operationalization Cheat Sheet (Jonas Directory)',
  },
  {
    id: 'spec-quality',
    term: 'Spec Quality',
    definition: 'The precision and completeness of a specification. In AI-SDLC, spec quality is the primary bottleneck — machines build exactly what you describe, including the ambiguities. If what you described was ambiguous, you get software that fills gaps with guesses, not customer-centric decisions.',
    example: 'A spec that says "handle edge cases gracefully" produces AI code that swallows exceptions silently. A spec that enumerates edge cases with expected behaviors produces correct software.',
    related: ['intent', 'dark-factory', 'human-accountability'],
    source: '5 Levels of AI Coding (Nate B Jones, 2026)',
  },
  {
    id: 'levels-of-ai-coding',
    term: 'Levels of AI Coding',
    definition: 'A maturity framework (L0–L5) by Dan Shapiro describing how deeply AI is integrated into software development. L0: autocomplete, L1: coding intern, L2: junior dev, L3: manager, L4: product manager, L5: dark factory. 90% of "AI-native" developers are at L2.',
    example: 'At L3, you direct AI and review PRs. At L4, you write specs and check outcomes. At L5, specs go in, software comes out — no human touches the code.',
    related: ['dark-factory', 'spec-quality', 'j-curve'],
    source: '5 Levels of AI Coding (Nate B Jones, 2026)',
  },
];
